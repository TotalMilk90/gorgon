...
IF ~GlobalLT("h_LiedelQuest","GLOBAL",2)~ THEN BEGIN 0
   SAY ~I'm sorry, friend, but I can't offer any services just yet. I'm still in training, seeking to complete my penance.~ IF ~~ THEN EXIT
END

IF ~GlobalGT("h_LiedelQuest","GLOBAL",1)~ THEN BEGIN 1
   SAY ~I'm sorry, friend, but I can't offer any services just yet. I'm still in training, seeking to complete my penance.~
...
IF ~~ THEN BEGIN 6
   SAY ~Permit me to flee. I'll journey the southern roads, aiding those in need. If you return my pendant, they'll assume I've met my end.~
