...
IF ~Global("h_CaughtByDay","GLOBAL",0) RandomNum(3,3)~ THEN BEGIN 0
   SAY @56500 /* I've got my sight's set on you, friend. Save yourself the trouble and disappear while you still can. */ IF ~~ THEN EXIT
END

IF ~Global("h_CaughtByDay","GLOBAL",0) RandomNum(3,1)~ THEN BEGIN 1
   SAY @56501 /* I've got a keen eye for trouble, and right now, it's wearin' your face. */ IF ~~ THEN EXIT
END

IF ~Global("h_CaughtByDay","GLOBAL",0) RandomNum(3,2)~ THEN BEGIN 2
   SAY @56502 /* You might think you're sly, but I'm watchin' your every step. */ IF ~~ THEN EXIT
END

IF WEIGHT #-1 ~PartyHasItem("h_misc04")~ THEN BEGIN 4
   SAY @56503 /* You right scoundrel! Think I'd miss that? I've got eyes in me boots! You've just signed your own death warrant, you have! */
IF ~~ THEN DO ~
